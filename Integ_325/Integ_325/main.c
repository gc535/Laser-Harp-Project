...
#define Sensor_Amount 7 //for testing
...
#define PB_OK 2
#define PB_TIMBRE 1
#define PB_INITILAZATION() (DDRA &= 0xE1)//change this
...
unsigned char index_buff[140] = {0};
unsigned char music_buff[185] = {0};

unsigned short music_ptr = 0x0000;
...
unsigned char music3[] = "   Music 3 Name";
